...
// 智慧报表分离
export const leaderhomeWork: any = [
  {
    path: 'SmartReport',
    name: 'SmartReport',
    ...
    children: [
      ...
      },
      {
        ...
        component: () => import('@/views/Workshop/AchievementsReport/TransportationFacilities.vue'),
        meta: {
      ...
      },
      {
        ...
        component: () => import('@/views/Workshop/AchievementsReport/TransmissionFacilities.vue'),
        meta: {
      ...
      },
      {
        ...
        component: () => import('@/views/Workshop/AchievementsReport/RadioTelevisionProject.vue'),
        meta: {
          title: '实物成果-广播电视工程',
          icon: 'ant-design:home-outlined'
        }
      ...
      },
      {
        ...
        component: () => import('@/views/Workshop/ScheduleReport/Enterprise/ProgressDetails.vue'),
        meta: {
          title: '进度管理-企业进度明细',
          icon: 'ant-design:home-outlined'
        }
      ...
      },
      {
        ...
        component: () => import('@/views/Workshop/ScheduleReport/LandNoMove/ProgressDetails.vue'),
        meta: {
          title: '进度管理-只征地不搬迁',
          icon: 'ant-design:home-outlined'
        }
      ...
      },
      {
        ...
        component: () => import('@/views/Workshop/ScheduleReport/Individual/ProgressDetails.vue'),
        meta: {
          title: '进度管理-个体户进度明细',
          icon: 'ant-design:home-outlined'
        }
      ...
      },
      {
        ...
        component: () => import('@/views/Workshop/ProfessionalProjectsExcel/telecommunication.vue'),
        meta: {
          title: '电信表格',
          icon: 'ant-design:home-outlined'
        }
      ...
      },
      {
        path: 'Achievements',
        name: 'Achievements',
        component: () => import('@/views/Workshop/DataQuery/SmartReport/Achievements/Index.vue'),
        meta: {
          title: '实物成果汇总',
          icon: 'ant-design:home-outlined'
        }
      },
      {
        path: 'OutcomeChange',
        name: 'OutcomeChange',
        component: () => import('@/views/Workshop/DataQuery/SmartReport/OutcomeChange/Index.vue'),
        meta: {
          title: '实物成果变更',
          icon: 'ant-design:home-outlined'
        }
      ...
      },
      {
        path: 'SmallSpecial',
        name: 'SmallSpecial',
        component: () => import('@/views/Workshop/DataQuery/SmartReport/SmallSpecial/Index.vue'),
        meta: {
          title: '小型专项及农副业设施',
          icon: 'ant-design:home-outlined'
        }
      },
      {
        ...
        component: () => import('@/views/Workshop/FundManage/PhysicalResults/IndividualBase.vue'),
        meta: {
          title: '个体户基本信息',
          hidden: false
        }
