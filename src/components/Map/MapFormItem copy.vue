<template>
  <el-form-item label="经纬度" :required="!!props.required">
    ...
    <Icon
      ...
      @click="focus"
    />
    <!-- <el-popover placement="top" width="424" trigger="click" @show="showPop">
      ...
      <template #reference>
        <div class="flex items-center w-full">
          ...
          <el-tooltip placement="top" content="请点击地图选择经纬度">
            <Icon class="ml-5px" icon="bi:question-circle" color="#231815" /> </el-tooltip
          >}
    ...
    <el-dialog v-model="mapShow" :show-close="false">
      <Map ref="mapRef" :h="400" :point="position" @chose="onChosePosition" v-if="mapShow" />
      <div v-if="position.address">{{ position.address }}</div></el-dialog
    >
  </el-form-item>
</template>
...
// ElPopover,
import { ElInput, ElFormItem, ElDialog } from 'element-plus'
