  ...
  <WorkContentWrap>
    ...
    <div class="table-wrap">
      <div class="flex items-center justify-between pb-12px">
        <div class="table-left-title"> 水电站资金发放明细报表 </div>
    ...
    <CommonFeeEdit :show="dialog" @close="onFormPupClose" type="2" :doorNo="currentDoorNo" />
  </WorkContentWrap>
</template>
...
const titles = ['智能报表', '资金管理', '企业', '水电站资金发放明细']
