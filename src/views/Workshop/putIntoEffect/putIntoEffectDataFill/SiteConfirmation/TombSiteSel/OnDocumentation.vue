...
import {
  getGraveDocumentationApi,
  saveGraveDocumentationApi
} from '@/api/putIntoEffect/putIntoEffectDataFill/SiteConfirmation/tombSiteSel-service'
...
const initData = () => {
  getGraveDocumentationApi(props.doorNo).then((res: any) => {
    form.value = res
...
const submit = async (data: any) => {
  await saveGraveDocumentationApi({
    ...data
  })
