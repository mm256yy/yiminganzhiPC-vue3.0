...
import { getImmigrantChooseHouseApi } from '@/api/putIntoEffect/putIntoEffectDataFill/SiteConfirmation/siteSel-service'
import { documentationCheckApi } from '@/api/putIntoEffect/putIntoEffectDataFill/SiteConfirmation/common-service'
