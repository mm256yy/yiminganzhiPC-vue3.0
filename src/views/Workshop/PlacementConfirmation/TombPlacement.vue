...
<template>
  <div class="flex items-center">
    ...
    <ElBreadcrumb separator="/">
      ...
      <ElBreadcrumbItem class="text-size-12px">安置确认</ElBreadcrumbItem>
      <ElBreadcrumbItem class="text-size-12px">坟墓安置</ElBreadcrumbItem>
    </ElBreadcrumb>
  </div>
  <WorkContentWrap>
    ...
    <div class="table-wrap">
      <div class="flex items-center justify-between pb-12px">
        <div class="table-left-title">坟墓安置报表</div>
