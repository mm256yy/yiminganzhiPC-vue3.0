<template>
  ...
  <div class="data-fill-body">
    <!-- 设施汇总 -->
    <UnicomFacilityReport v-if="tabCurrentId === 1" />

    <!-- 房屋及其附属物设备汇总 -->
    <UnicomAppendReport v-else />
  </div>
</template>
...
import UnicomFacilityReport from './UnicomFacilityReport.vue' // 设施汇总
import UnicomAppendReport from './UnicomAppendReport.vue' // 房屋及其附属物设备汇总
