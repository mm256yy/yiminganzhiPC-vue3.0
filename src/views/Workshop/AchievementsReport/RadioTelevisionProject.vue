<template>
  ...
  <div class="data-fill-body">
    <!-- 设施汇总 -->
    <BroadFacilityReport v-if="tabCurrentId === 1" />

    <!-- 房屋及其附属物设备汇总 -->
    <BroadAppendReport v-else />
  </div>
</template>
...
import BroadFacilityReport from './BroadFacilityReport.vue' // 设施汇总
import BroadAppendReport from './BroadAppendReport.vue' // 房屋及其附属物设备汇总
