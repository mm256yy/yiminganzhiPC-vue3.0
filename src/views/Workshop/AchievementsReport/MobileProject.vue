<template>
  ...
  <div class="data-fill-body">
    <!-- 设施汇总 -->
    <MoveFacilities v-if="tabCurrentId === 1" />

    <!-- 房屋及其附属物设备汇总 -->
    <MoveAppendage v-else />
  </div>
</template>
...
import MoveFacilities from './MoveFacilities.vue' // 设施汇总
import MoveAppendage from './MoveAppendage.vue' // 房屋及其附属物设备汇总
