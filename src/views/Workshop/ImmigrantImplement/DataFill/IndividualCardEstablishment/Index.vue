  ...
  <WorkContentWrap>
    <div class="table-wrap !py-12px !mt-0px">
      ...
      >
        <ElRow>
          ...
          <ElCol :span="6">
            <ElFormItem label="迁前地址" prop="beforeAddress">
    ...
    >
      <div style="width: 50%; padding-right: 10px">
        <h1 style="font-size: 24px; text-align: center">个体户协议补偿登记卡</h1>
        <div
          style="
            display: flex;
        ...
        >
          <div style="width: 50%">
            <span style="font-weight: bold">个体户名称:</span>
            <span style="margin-left: 5px">{{ baseInfo.name }}</span>
          </div>
          <div style="width: 50%">
            <span style="font-weight: bold">个体户编号:</span>
        ...
        <h2 style="margin: 20px; font-size: 18px; text-align: center"> 个体工商户账户信息</h2>
