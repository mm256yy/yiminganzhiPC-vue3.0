  ...
  <WorkContentWrap>
    <div class="flex items-center">
      ...
      <ElBreadcrumb separator="/">
        ...
        <ElBreadcrumbItem class="text-size-12px">资金预拨详情</ElBreadcrumbItem>
      </ElBreadcrumb>
    </div>
...
import { getfunReceiptsRecord } from '@/api/fundManage/fundEntry-service'
