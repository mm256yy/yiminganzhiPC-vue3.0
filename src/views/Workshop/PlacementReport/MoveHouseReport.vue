  ...
  <WorkContentWrap>
    ...
    <div class="table-wrap">
      ...
      <el-table
        ...
        style="width: 100%"
      >
        <el-table-column prop="hz" label="户主" align="center" width="180">
        ...
        <el-table-column label="公寓房(套)" align="center">
          <el-table-column label="曙光安置区" width="120" align="center">
            <el-table-column prop="a" label="70" align="center" width="50" />
            <el-table-column prop="b" label="90" align="center" width="50" />
            <el-table-column prop="c" label="110" align="center" width="50" />
            <el-table-column prop="d" label="130" align="center" width="50" />
          </el-table-column>
          <el-table-column label="镜岭集镇安置区" width="120" align="center">
            <el-table-column prop="e" label="70" align="center" width="50" />
            <el-table-column prop="f" label="90" align="center" width="50" />
            <el-table-column prop="g" label="110" align="center" width="50" />
        ...
        <el-table-column prop="test" label="宅基地(宗)" align="center">
          <el-table-column label="棠村安置区" align="center">
            <el-table-column prop="i" label="48" align="center" width="50" />
