...
import {
  getLandNoMoveWorkGroupStatisiListApi,
  exportLandNoMoveWorkGroupStatisiListApi
...
const titles = ['智能报表', '进度管理', '只征地不搬迁', '工作组统计']
...
const onExport = async () => {
  ...
  const res = await exportLandNoMoveWorkGroupStatisiListApi(params)
...
const getTableList = async () => {
  ...
  const res = await getLandNoMoveWorkGroupStatisiListApi(params).finally(() => {
