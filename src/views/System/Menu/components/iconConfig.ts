const textToArray = (text: string, prefix: string) => {
  if (!text) return []
  return text.split('\n').map((item) => `${prefix}:${item}`)
}

// https://github.com/ant-design/ant-design-icons/packages/icons-svg/scripts/digest.txt

const antdIconTexts = `account-book-filled
...
// antd的图标
export const AntdIcons = textToArray(antdIconTexts, 'ant-design')
